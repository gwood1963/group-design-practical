  ...
  return (    
    <MainWrapper>
      ...
      <div className = "welcome">
        ...
        <div className = "textbox" style ={{visibility: "hidden", animation: "fadeIn 1s forwards", animationDelay: "2.5s", fontSize: "50px"}}>You seem like you like a puzzle.</div>
        <div className = "textbox" style= {{visibility: "hidden", animation: "fadeIn 2s forwards", animationDelay: "4.5s"}}>Want to try ours?</div>
